...
public class MicroserviceDemandApplication {
    ...
    public static void main(String[] args) {
        ...
        demandRepository.save(new Demand(10, 1, l.get(0), Long.MIN_VALUE));
        demandRepository.save(new Demand(100000, 2, l.get(1), Long.MIN_VALUE));
        demandRepository.save(new Demand(100, 3, l.get(2), Long.MIN_VALUE));
